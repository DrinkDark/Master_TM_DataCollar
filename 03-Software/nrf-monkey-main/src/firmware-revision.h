...
// firmware revision
#define FIRMWARE_REVISION                   "1.2.2-SNAPSHOT"
#define FIRMWARE_REVISION_MAJOR             1
#define FIRMWARE_REVISION_MINOR             2
#define FIRMWARE_REVISION_PATCH             2
#define FIRMWARE_REVISION_NUMBER            10202       // This is the firmware revision expressed as an int. Example: 1.2.3 -> 010203
