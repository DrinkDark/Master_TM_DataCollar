...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DELAY_ON_HARDWARE_POWERED_ON, 2000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HOT_RESET_VAL, 165);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STORAGE_CD_DEBOUNCE_MS, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STORAGE_MOUNT_POINT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STORAGE_DISK_POINTER_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STORAGE_FILE_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STORAGE_FILE_EXTENSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BTN_HAL_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_HAL_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_SPIM20, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_MAX_NUM_UP_BUFFERS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_MAX_NUM_DOWN_BUFFERS, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_SPIM20, 1);
